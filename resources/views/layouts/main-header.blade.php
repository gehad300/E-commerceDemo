...
-->
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            <img src="{{ URL::asset('assets/media/avatars/150-26.jpg') }}" alt="user" />
                        </div>
                        <!--begin::Menu-->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo"
                                            src="{{ URL::asset('assets/media/avatars/150-26.jpg') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                ...
                                <a href="#" class="menu-link px-5">
                                    <span class="menu-title position-relative">Language
                                        {{-- @if (App::getLocale() == 'en') --}}
                                            <span
                                                class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ trans('main_trans.English') }}
                                                <img class="w-15px h-15px rounded-1 ms-2"
                                                    src="{{ URL::asset('assets/media/flags/united-states.svg') }}"
                                                    alt="" /></span>
                                        {{-- @else --}}
                                            <span
                                                class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ trans('main_trans.Arabic') }}
                                                <img class="w-15px h-15px rounded-1 ms-2"
                                                    src="{{ URL::asset('assets/media/flags/egypt.svg') }}"
                                                    alt="" /></span>
                                        {{-- @endif --}}
                                        ...
                                        <a href="../../demo1/dist/account/settings.html"
                                            ...
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="{{ URL::asset('assets/media/flags/united-states.svg') }}"
                                                    alt="" />
                                            </span>{{ trans('main_trans.English') }}</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="../../demo1/dist/account/settings.html"
                                            ...
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="{{ URL::asset('assets/media/flags/egypt.svg') }}"
                                                    alt="" />
                                            </span>{{ trans('main_trans.Arabic') }}</a>
                                    </div>
                                    <!--end::Menu item-->
